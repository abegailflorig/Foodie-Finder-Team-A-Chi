  ...
  return (
    <div className="w-full min-h-screen bg-[#FFF9E8] pb-24 overflow-x-hidden">
      ...
      <div className="bg-[#FFC533] h-48 rounded-b-3xl p-5 relative flex flex-col justify-between">
        ...
        <h1 className="text-[54px] font-regular font-['Neuton',sans-serif] -mt-6">
          Favorites
        </h1>
      </div>
          ...
          >
            ...
            <img
              ...
              className="
                ...
                w-38 h-38 object-cover rounded-full shadow-xl z-10
                max-[640px]:w-28 max-[640px]:h-28
                max-[480px]:w-24 max-[480px]:h-24
            ...
            <div className="flex-1 pr-14 flex flex-col justify-center max-[480px]:pr-10">
              ...
              <p className="font-semibold font-['Neuton',sans-serif] text-[30px] text-black leading-tight max-[480px]:text-[24px]">
                {item.name}
              </p>
